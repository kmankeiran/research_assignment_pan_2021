...
function login($username, $password, $ip)
{
    ...
    ##  TODO: Finish the following query to check if the username and password are matching the DB
    ...
    if($found_user = $user_set->fetch(PDO::FETCH_ASSOC)){
        //We found user in the DB, get them in!
        ...
        return 'Learn how to type you dingus.';
    }
}
